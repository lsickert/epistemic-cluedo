...
class Player:
    ...
    def check_hand_cards(self, suggestion):
        ...
        possible_matches = [card for card in self.hand_cards if card in temp_sugg]
    ...
    def build_hand_cards_model(self, player_id: str, num_hand_cards: int, possible_cards: list):
        ...
        combinations = itertools.product(possible_cards, repeat=num_hand_cards)

        self.hand_card_models[str(player_id)] = kripke.create_single_kripke_model(combinations)
