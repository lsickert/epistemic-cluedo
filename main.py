...
if __name__ == "__main__":
    ...
    num_characters = int(input("How many characters? (default 5, max 6) "))
    num_weapons = int(input("How many weapons? (default 5, max 6) "))
    num_rooms = int(input("How many rooms? (default 5, max 9) "))
