...
plt.xlabel('Turn')
plt.ylabel('Mean number of worlds')
plt.plot(results[4], label= '2')
plt.plot(results[5], label= '1')
plt.legend(loc="upper right")
...
plt.xlabel('Turn')
plt.ylabel('Mean number of worlds')
plt.plot(results[6], label= '2')
plt.plot(results[7], label= '1')
plt.plot(results[8], label= '0')
plt.legend(loc="upper right")
